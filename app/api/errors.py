...
class ErrorCode(str, Enum):
    ...
    COMPOSITE_COMPONENT_NOT_FOUND = "COMPOSITE_COMPONENT_NOT_FOUND"
    COMPOSITE_VALIDATION_FAILED = "COMPOSITE_VALIDATION_FAILED"
    COMPOSITE_BACKTEST_NOT_FOUND = "COMPOSITE_BACKTEST_NOT_FOUND"
    COMPOSITE_BACKTEST_FAILED = "COMPOSITE_BACKTEST_FAILED"
