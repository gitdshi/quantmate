...
('tushare', 'moneyflow',       '资金流向',      1, '个股资金流向数据',                '0',       'tushare', 'stock_moneyflow', 0, 25),
('tushare', 'stk_limit',       '涨跌停统计',    1, '涨跌停数据(封单/强度)',           '0',       'tushare', 'stk_limit',       0, 70),
('tushare', 'margin_detail',   '融资融券',      1, '融资融券余额明细',                '0',       'tushare', 'margin',          0, 80),
...
('tushare', 'dividend',        '分红送股',      0, '分红送股数据(需高级权限)',         '1',       'tushare', 'stock_dividend',  0, 50),
