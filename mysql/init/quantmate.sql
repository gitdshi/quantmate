...
-- Includes folded migration state through 045
-- =============================================================================
...
INSERT IGNORE INTO schema_migrations (version, name) VALUES
    ...
    ('041', '041_make_us_daily_latest_only.sql'),
    ('042', '042_widen_varchar_columns.sql'),
    ('043', '043_fix_auto_inferred_unique_keys.sql'),
    ('044', '044_disable_permission_locked_interfaces.sql'),
    ('045', '045_add_backfill_analysis_columns_to_data_source_items.sql');
...
CREATE TABLE IF NOT EXISTS data_source_items (
    ...
    supports_backfill   TINYINT(1)   DEFAULT NULL COMMENT 'Parameter-derived historical backfill support',
    backfill_mode       VARCHAR(20)  DEFAULT NULL COMMENT 'Parameter-derived backfill strategy: range/date/code/code_date/other',
    input_params        TEXT         DEFAULT NULL COMMENT 'Raw input parameter names from interface analysis',
    input_param_details TEXT         DEFAULT NULL COMMENT 'Human-readable analyzed input parameter details',
    analysis_date_params TEXT        DEFAULT NULL COMMENT 'Date-axis params extracted from interface analysis',
    input_params_meta   JSON         DEFAULT NULL COMMENT 'Machine-readable analyzed input parameter metadata',
    updated_at          DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Migration 040: Add sync_mode to data_source_items
UPDATE `quantmate`.`data_source_items`
...
-- Migration 041: Make us_daily latest_only
UPDATE `quantmate`.`data_source_items`
SET sync_mode = 'latest_only'
...
-- Migration 044: Disable permanently permission-locked interfaces
UPDATE `quantmate`.`data_source_items`
SET enabled = 0
WHERE source = 'tushare'
    AND item_key IN (
...
-- Migration 045: Seed backfill-analysis metadata onto existing catalog rows
