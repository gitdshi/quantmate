...
CREATE TABLE IF NOT EXISTS `quantmate`.`portfolios` (
    ...
    CONSTRAINT fk_port_user FOREIGN KEY (user_id) REFERENCES `quantmate`.`users`(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `quantmate`.`portfolio_positions` (
    id           INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    CONSTRAINT fk_pos_port FOREIGN KEY (portfolio_id) REFERENCES `quantmate`.`portfolios`(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `quantmate`.`portfolio_transactions` (
    id           INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
    portfolio_id INT          NOT NULL,
    symbol       VARCHAR(20)  NOT NULL,
    ...
    CONSTRAINT fk_tx_port FOREIGN KEY (portfolio_id) REFERENCES `quantmate`.`portfolios`(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

CREATE TABLE IF NOT EXISTS `quantmate`.`portfolio_snapshots` (
    id           INT          NOT NULL AUTO_INCREMENT PRIMARY KEY,
    portfolio_id INT          NOT NULL,
    date         DATE         NOT NULL,
    ...
    CONSTRAINT fk_snap_port FOREIGN KEY (portfolio_id) REFERENCES `quantmate`.`portfolios`(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
